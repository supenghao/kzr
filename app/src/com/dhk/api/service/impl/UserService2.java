...
//	static Logger logger = Logger.getLogger(UserService2.class);
...
//						+ "merchantid =:merchantid, mobilephone=:mobilephone,is_auth =:is_auth,realname=:realName,id_number=:idNumber,"
