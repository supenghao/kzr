...
public class YunPainSmsUtil {
    ...
    public static String CHECK_CODE_TEMPLATE = "欢迎使用开心还，您的手机验证码是code。本条信息无需回复";
    public static String CHECK_MESSAGE = "尊敬的用户您好，你提交的实名认证审核result";


    public static String TRANS_NOTICE_MESSAGE = "" ;
