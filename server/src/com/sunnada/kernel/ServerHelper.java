...
public class ServerHelper {
	...
	private ServerSupport findOrcreateInstance(ServerDef def) {
		...
		if (instance == null) {
			try {
				...
				throw new com.sunnada.kernel.exception.BaseException("server " + def.getName() + " 实例化失败", e);
			}
	...
	public void restartBackend(String serverName) {
		...
		if (def == null)
			throw new com.sunnada.kernel.exception.BaseException("系统没有定义后台服务:" + serverName);
