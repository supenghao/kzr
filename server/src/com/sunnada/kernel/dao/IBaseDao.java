...
public interface IBaseDao <T extends com.sunnada.kernel.entity.Entity,PK extends Serializable>{
	...
	public void batchUpdate(String sql,List<com.sunnada.kernel.dao.jdbc.Ids> a);
