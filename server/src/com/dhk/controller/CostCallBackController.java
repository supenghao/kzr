...
public class CostCallBackController extends BaseController {
	@Autowired
	JedisPool jedisPool;
	...
	public void purchase(HttpServletRequest request,HttpServletResponse response) throws Exception{
		...
		String outTradeNo = request.getParameter("prdOrdNo");
		...
		log.info("签名:"+sign);
//		if(signData!=null&&signData.equals(sign)){
//			log.info("签名成功");
