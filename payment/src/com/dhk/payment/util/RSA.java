...
public class RSA {
    ...
    public static boolean verifySign(String data, String sign,
        ...
        try {
            byte[] dataByte = data
                    .getBytes("UTF-8");
            byte[] signByte = Hlb_Base64.decode(sign
                    .getBytes("UTF-8"));
    ...
    public static String sign(String data, PrivateKey key) {
        try {
            ...
            return new String(Hlb_Base64.encode(sign(dataByte, key)));
        } catch (UnsupportedEncodingException e) {
            throw new RuntimeException("sign fail!", e);
        }
    }
    ...
    public static String encryptToBase64(String data, Key key, String padding) {
        try {
            return new String(Hlb_Base64.encode(encrypt(
                    data.getBytes("UTF-8"),
                    key, padding)));
        } catch (Exception e) {
            throw new RuntimeException("encrypt fail!", e);
    ...
    public static String decryptFromBase64(String data, Key key, String padding) {
        try {
            return new String(decrypt(Hlb_Base64.decode(data.getBytes()), key, padding),
                    "UTF-8");
        } catch (Exception e) {
            throw new RuntimeException("encrypt fail!", e);
        }
    ...
    public static void createKeyPairs(int size) throws Exception {
        ...
        String strpk = new String(Hlb_Base64.encodeBase64(pk));
        String strprivk = new String(Hlb_Base64.encodeBase64(privk));
    ...
    public static PublicKey getPublicKey(String base64EncodePublicKey) throws Exception {
        ...
        X509EncodedKeySpec pubX509 = new X509EncodedKeySpec(Hlb_Base64.decodeBase64(base64EncodePublicKey.getBytes()));
    ...
    public static PrivateKey getPrivateKey(String base64EncodePrivateKey) throws Exception {
        KeyFactory keyf = KeyFactory.getInstance("RSA", PROVIDER);
        PKCS8EncodedKeySpec priPKCS8 = new PKCS8EncodedKeySpec(Hlb_Base64.decodeBase64(base64EncodePrivateKey.getBytes()));
    ...
    public static String encodeToBase64(String data, Key key, String padding) {
        try {
            return new String(Hlb_Base64.encode(encode(data,
                    key, padding)));
        } catch (Exception e) {
            throw new RuntimeException("encrypt fail!", e);
        }
    ...
    public static String decodeFromBase64(String data, Key key, String padding) {
        try {
            return new String(decode(Hlb_Base64.decode(data.getBytes()), key, padding).getBytes(),
                    "UTF-8");
        } catch (Exception e) {
            throw new RuntimeException("encrypt fail!", e);
        }
