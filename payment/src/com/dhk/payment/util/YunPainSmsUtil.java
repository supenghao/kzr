...
public class YunPainSmsUtil {
    ...
    //public static String CHECK_CODE_TEMPLATE = "【妥妥科技】欢迎使用妥妥信用卡管家，您的手机验证码是code。本条信息无需回复";
    //public static String CHECK_CODE_TEMPLATE = "【稳稳科技】欢迎使用（稳稳信用卡管家），您的手机验证码是code。";
    
    public static String CHECK_CODE_TEMPLATE = "【睿淘科技】欢迎使用睿淘信用卡管家，您的手机验证码是code。本条信息无需回复";
    public static String TRANS_NOTICE_MESSAGE = "【睿淘科技】尊敬的睿淘卡管家用户您好：您尾号为cardNo的信用卡于repayDate的还款计划未能成功执行，为避免错过正常还款时间，请及时进入睿淘卡管家APP重新制定还款计划。";
    public static String TEST = "【睿淘科技】尊敬的睿淘卡管家用户您好：billDate是您尾号为cardNo信用卡的账单日，请及时进入睿淘卡管家APP，提前设置还款计划，省心还款。";
